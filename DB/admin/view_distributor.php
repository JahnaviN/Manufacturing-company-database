...
$drid=$_GET['drid'];
//echo $drid;
$sql="SELECT * FROM Distributor WHERE DistributorID=$drid";
...
echo "<tr><td>DistributorID</td><td>" . $list['DistributorID'] . "</td></tr>";
echo "<tr><td>Name</td><td>".$list['Name']."</td></tr>";
echo "<tr><td>Zone</td><td>".$list['Zone']."</td></tr>";
...
echo "<form action=\"edit_distributor.php?drid=$drid\" method=\"POST\">";
